...
atm_measured_variables = ['PREC_ACC_C', 'PREC_ACC_NC', 'SNOW_ACC_NC', 'U10', 'V10', 'HFX', 'LH', 'SWDNB', 'LWDNB', 'SST']
...
for j, varname in enumerate(plot_variables):
    ...
    for i, sim_name in enumerate(sim_names):
        ...
        _ax.set_title("%s" % (plot_info['label'], ) )
